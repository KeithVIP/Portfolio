...
const TechnologyList = () => {
    return (
        <section className='font-Cutive z-10 max-h-min flex flex-col justify-center items-center overflow-hidden p-10 mt-10'>
            <h2 className='font-black text-4xl'>Technologies</h2>

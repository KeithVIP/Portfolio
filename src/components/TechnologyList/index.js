...
const TechnologyList = () => {
    return (
        <section className='z-10 max-h-min font-cutiive flex flex-col justify-center items-center overflow-hidden p-10 mt-10'>
            <h2 className='font-cutive font-bold text-7xl'>Technologies</h2>

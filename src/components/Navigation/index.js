...
const Navigation = (props) => {
    ...
    return (
        <header className='flex flex-col max-h-full w-screen'>
            <Menu as='div' className='laptop:flex bg-c-white text-c-black justify-start relative p-2'>
                {({ open }) => (
                    <>
                                                ...
                                                {({ active }) => (
                                                    <a
                                                        ...
                                                        className={classNames(
                                                            ...
                                                            'block px-4 py-2 text-xl animate-nav3-down laptop:animate-nav3-slide laptop:text-c-black active:text-c-blue'
                                                        )}
                                                    >
                                                        {item.label}
                                                    </a>

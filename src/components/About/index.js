...
<<<<<<< HEAD
            <div id='container' className='w-3/5 flex flex-col items-center'>
                ...
                <p className="z-10 animate-slider2 font-Cutive font-bold text-sm laptop:text-2xl text-c-white bg-c-shade rounded-xl p-1 text-justify max-w-lg tablet:max-w-md laptop:max-w-lg">
